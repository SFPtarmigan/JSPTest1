...
<html>
    ...
    <body>
        <form action="questionDelete.jsp" method="post">
            <table border="1">
                <tbody>
                    <tr>
                        <td>题目编号</td>
...
<%
    ...
    if(questionId != null && title != null && optionA != null && optionB != null && optionC != null && optionD != null && answer != null){
        pjdbc.updateQuestionUpdate(questionId,title,optionA,optionB,optionC,optionD,answer);
    }
%>
